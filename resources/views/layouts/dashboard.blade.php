        ...
        <div id="navigation">
            ...
            <ul class="navigation-menu">
                ...
                <li class="has-submenu">
                    <a href="{{ url('/dashboard') }}"><i class="icon-speedometer"></i>Beranda</a>
                </li>
                @if(auth()->user()->level == 'admin')
                <li class="has-submenu">
                    <a href="#"><i class="icon-layers"></i>Data</a>
                    <ul class="submenu">
                       <li><a href="{{ url('dashboard/data-siswa') }}">Data Siswa</a></li>
                       <li><a href="{{ url('dashboard/data-petugas') }}">Data Petugas</a></li>
                   </ul>
               </li>

               <li class="has-submenu">
                <a href="{{ url('dashboard/data-kelas') }}"><i class="icon-briefcase"></i>Data Kelas</a>

            </li>

            <li class="has-submenu">
                <a href="{{ url('dashboard/data-spp') }}"><i class="icon-fire"></i>Data SPP</a>

            </li>

            <li class="has-submenu">
                <a href="#"><i class="icon-docs"></i>Pembayaran</a>
                <ul class="submenu megamenu">


                 <li><a href="{{ url('dashboard/pembayaran') }}">Entri Transaksi</a></li>
                 @endif
                 <li><a href="{{ url('dashboard/histori') }}">Rekap Pembayaran</a></li>
                 @if(auth()->user()->level == 'admin')
                 <li><a href="{{ url('dashboard/laporan') }}">Laporan Pembayaran</a></li>
                 @endif  
